			...
			<div id="sbg_box" class="postbox " >
				...
				<div class="inside">
					<div class="sbg_container">
						...
						<p>Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under Appearance > Manage Sidebars.<br><img src="http://geekpics.net/images/2014/09/11/rukI8.jpg">
						</p>
						<ul>
							<?php
